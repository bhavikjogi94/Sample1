...
<asp:Content ID="PageMainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#grdCustomer_chkHeader').click(
                function () {
                    if ($(this).is(':checked')) {
                        $('input[id*="grdCustomer_chkItem"]:checkbox').each(
                            function () {
            ...
            $('input[id*="grdCustomer_chkItem"]:checkbox').click(
                function () {
                    if ($(this).is(':checked') == false) {
                        $('#grdCustomer_chkHeader').prop('checked', false);
                    }
                    else {
                        if ($('input[id*="grdCustomer_chkItem"]:checkbox').length == $('input[id*="grdCustomer_chkItem"]:checkbox:checked').length) {
                            $('#grdCustomer_chkHeader').prop('checked', true);
                        }
                    }
                });
        });
